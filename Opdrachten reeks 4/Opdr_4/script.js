...
//je krijgt een lijst terug, ook al zit er maar 1 object in die lijst moet je altijd specifiëren met [0] dat het eerste element uit die lijst gebruikt moet worden indien je dat wenst
let redBox = document.getElementsByClassName("color red")[0];
console.log(redBox);
let greenBox = document.getElementsByClassName("color green")[0];
let blueBox = document.getElementsByClassName("color blue")[0];

redBox.addEventListener("click", redText);
greenBox.addEventListener("click", greenText);
blueBox.addEventListener("click", blueText);
*/
...
function checkPassword(event) {
    ...
    if (password.value !== confirm.value) {
        ...
        confirm.style.border = "green 2px solid";
    }
}
